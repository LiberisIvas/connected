...
<form id="head" action="Logged" method="Post">
	...
	<input class="btn-primary btn-lg" type="submit"  name="act" value="Head" style="height:180px; width:33%">
...
<form id="hand" action="Logged" method="Post">
	...
	<input class="btn-primary btn-lg" type="submit" name="act" value="Hand" style="height:180px; width:33%">
	<input type="hidden" name="action" value="Hand">
</form>
<form id="ear" action="Logged" method="Post">
	
	<input class="btn-primary btn-lg" type="submit" name="act" value="Ear" style="height:180px; width:33%">
...
<form id="eye" action="Logged" method="Post">
	...
	<input class="btn-primary btn-lg" type="submit" name="act" value="Eye" style="height:180px; width:33%">
	<input type="hidden" name="action" value="Eye">
<!-- <form name="action" method="Post"> -->
</form>
<form id="body" action="Logged" method="Post">
	
	<input class="btn-primary btn-lg" type="submit" name="act" value="Body" style="height:180px; width:33%">
...
<form id="other" action="Logged" method="Post">
	...
	<input class="btn-primary btn-lg" type="submit" name="act" value="Other" style="height:180px; width:33%">
	<input type="hidden" name="action" value="Other">
	</form>

 <form id="Messages_btn" method="post" action="/Logged/go_to_messages" ><button class="btn-primary btn-lg" type="submit" name="mail" style="height:180px; width:99.6%" >go to mail</button></form>
